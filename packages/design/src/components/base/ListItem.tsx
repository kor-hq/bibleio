  ...
  return (
    <RadixCollapsible.Root open={open} onOpenChange={setOpen} {...props}>
      <RadixCollapsible.Trigger
        className={clsx(
          `group flex w-full items-center justify-between gap-x-8 ${selected && "rounded-12 border-stroke bg-fg-2 shadow-material-component border"} text-text px-12 py-8`,
          className
        )}
      >
        {text}
